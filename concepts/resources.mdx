...
title: Resources
description: |
  Resources in Ctrlplane represent any entity that pipelines can execute
  against. This includes traditional infrastructure (e.g., EKS clusters) and
  abstract concepts (e.g., Salesforce accounts).
---

<iframe
  className="w-full aspect-video"
  src="https://www.youtube.com/embed/aN_cxngJZHc"
  frameborder="0"
  allowfullscreen
></iframe>
